...
description: Regenerate the cross-repo roadmap aggregate at `~/.claude/projects/-Users-lucassantana/memory/roadmap-all.md` by walking every curated repo's `docs/specs/**` frontmatter. Run at session start for cross-repo orientation or after any `spec-new`/`spec-ship` in any repo.
type: skill
---
...
Writes to `~/.claude/projects/-Users-lucassantana/memory/roadmap-all.md`.
