...
### plans  `~/.claude/plans/homelab-lan-wide.md:40-60`  ...
```
...
## Eval baseline
Retrieval layer is measured via `~/.claude/rag-index/eval/run.py` (MRR + Hit@K on 20 real queries). Baseline MRR 0.63 · Hit@3 0.65 · Hit@5 0.70. Any change to chunking / RRF / reranker must not regress.
